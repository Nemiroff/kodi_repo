...
class Future(object):
            ...
            if self._state == FINISHED:
                if self._exception:
                    return '<Future at %s state=%s raised %s>' % (
                        ...
                        self._exception.wrapped.__class__.__name__)
                else:
    ...
    def __get_result(self):
        if self._exception:
            raise self._exception.raise_wrapped()
        else:
            return self._result
    ...
    def exception(self, timeout=None):
        ...
        with self._condition:
            if self._state in [CANCELLED, CANCELLED_AND_NOTIFIED]:
                ...
                return self._exception.wrapped
